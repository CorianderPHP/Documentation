...
<body class="flex min-h-screen w-full flex-col bg-white text-black scrollbar dark:bg-black dark:text-white">
    <header class="fixed bottom-0 z-50 flex w-full flex-col-reverse font-concert-one pointer-events-none md:sticky md:top-0 md:bottom-auto md:flex-col">
        <div class="w-full text-sm sm:text-lg md:text-2xl border-t border-dark-green/15 bg-true-white/95 shadow-sm backdrop-blur dark:border-peach/15 dark:bg-black/90 md:border-b md:border-t-0">
            <nav class="relative mx-auto flex h-16 w-full max-w-screen-2xl overflow-x-auto px-4 pr-6 pointer-events-auto y-slider sm:px-6 sm:pr-8 md:h-16 md:justify-end md:overflow-visible lg:px-8">
                <div class="flex min-w-max items-center gap-5 text-sm sm:gap-6 sm:text-base sm:tracking-1 md:gap-10 md:text-2xl">
                    <div class="flex w-auto gap-5 sm:gap-6 md:gap-10">
                        <a href="/home" title="Go to the Home Page" class="relative flex h-16 items-center whitespace-nowrap after:absolute after:content-[''] after:bottom-3 after:h-[2px] md:after:bottom-3 md:after:h-[3px] after:inset-x-0 after:mx-auto after:bg-dark-green dark:after:bg-peach <?= $requestedView === 'home' ? "after:w-full" : "after:w-0 hover:after:w-full after:transition-['width']" ?>">Home</a>
                        <a href="/docs" title="Read the documentation" class="relative flex h-16 items-center whitespace-nowrap after:absolute after:content-[''] after:bottom-3 after:h-[2px] md:after:bottom-3 md:after:h-[3px] after:inset-x-0 after:mx-auto after:bg-dark-green dark:after:bg-peach <?= str_starts_with($requestedView, 'docs') ? "after:w-full" : "after:w-0 hover:after:w-full after:transition-['width']" ?>"><span class="sm:hidden">Docs</span><span class="hidden sm:inline">Documentation</span></a>
                        <a href="/start" title="Learn how to start a CorianderPHP project" class="relative flex h-16 items-center whitespace-nowrap after:absolute after:content-[''] after:bottom-3 after:h-[2px] md:after:bottom-3 md:after:h-[3px] after:inset-x-0 after:mx-auto after:bg-dark-green dark:after:bg-peach <?= str_starts_with($requestedView, 'start') ? "after:w-full" : "after:w-0 hover:after:w-full after:transition-['width']" ?>">Start</a>
                        <a href="/guided-projects" title="Explore guided CorianderPHP projects" class="relative flex h-16 items-center whitespace-nowrap after:absolute after:content-[''] after:bottom-3 after:h-[2px] md:after:bottom-3 md:after:h-[3px] after:inset-x-0 after:mx-auto after:bg-dark-green dark:after:bg-peach <?= str_starts_with($requestedView, 'examples') ? "after:w-full" : "after:w-0 hover:after:w-full after:transition-['width']" ?>"><span class="sm:hidden">Guides</span><span class="hidden sm:inline">Guided Projects</span></a>
                        <a href="https://github.com/CorianderPHP/CorianderPHP/issues" target="_blank" rel="noopener noreferrer" title="Report a bug on GitHub" class="relative flex h-16 items-center whitespace-nowrap after:absolute after:content-[''] after:bottom-3 after:h-[2px] md:after:bottom-3 md:after:h-[3px] after:inset-x-0 after:mx-auto after:w-0 after:bg-dark-green hover:after:w-full after:transition-['width'] dark:after:bg-peach"><span class="sm:hidden">Bug</span><span class="hidden sm:inline">Report Bug</span></a>
                    </div>
                </div>
            </nav>
        </div>
