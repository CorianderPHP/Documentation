...
<section class="px-4 py-10 font-poppins sm:px-6 lg:px-8">
    <div class="mx-auto max-w-5xl">
        ...
        <h1 class="mt-5 max-w-4xl font-concert-one text-5xl leading-tight text-dark-green dark:text-peach md:text-7xl">
            Documentation
        </h1>
        ...
        <div class="mt-12 divide-y divide-dark-green/10 border-y border-dark-green/10 dark:divide-peach/10 dark:border-peach/15">
            <a href="/start" class="grid gap-2 py-6 transition px-3 hover:bg-black/5 md:grid-cols-[13rem_1fr_auto] md:items-center">
            ...
            <a href="/docs" class="grid gap-2 py-6 transition px-3 hover:bg-black/5 md:grid-cols-[13rem_1fr_auto] md:items-center">
            ...
            <a href="/guided-projects/forum" class="grid gap-2 py-6 transition px-3 hover:bg-black/5 md:grid-cols-[13rem_1fr_auto] md:items-center">
