<section class="mt-8 border-t border-dark-green/10 pt-6 dark:border-mint/15" data-api-playground>
    <div class="grid gap-5 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]">
        <div>
            <p class="text-sm font-semibold uppercase tracking-1 text-dark-green dark:text-mint">Request</p>
            <div class="mt-4 grid gap-3 sm:grid-cols-[8rem_1fr]">
                ...
                <select id="api-playground-preset" class="rounded-md border border-dark-green/15 bg-true-white px-3 py-2 text-sm text-black outline-none focus:border-dark-green dark:border-mint/20 dark:bg-true-black dark:text-white dark:focus:border-mint" data-api-preset>
                ...
                <input id="api-playground-method" class="rounded-md border border-dark-green/15 bg-true-white px-3 py-2 text-sm text-black outline-none dark:border-mint/20 dark:bg-true-black dark:text-white" data-api-method readonly />
                <label class="text-sm font-semibold text-black/70 dark:text-white/70" for="api-playground-url">URL</label>
                <input id="api-playground-url" class="rounded-md border border-dark-green/15 bg-true-white px-3 py-2 text-sm text-black outline-none focus:border-dark-green dark:border-mint/20 dark:bg-true-black dark:text-white dark:focus:border-mint" data-api-url />
            </div>
        ...
        <div>
            ...
            <div class="mt-4 rounded-md border border-dark-green/15 bg-true-white dark:border-mint/20 dark:bg-true-black">
                <div class="border-b border-dark-green/10 px-4 py-3 text-sm font-semibold text-black/70 dark:border-mint/15 dark:text-white/70" data-api-status>Status: waiting</div>
                <pre class="max-h-96 min-h-52 overflow-auto p-4 text-sm text-black dark:text-white md:min-h-96"><code data-api-response>{
