...
<section class="px-4 py-10 font-poppins sm:px-6 lg:px-8">
    ...
    <div class="mt-10 divide-y divide-dark-green/10 dark:divide-peach/10">
        <?php foreach ($projects as $projectEntry): ?>
            ...
            <a href="<?= htmlspecialchars($project->basePath, ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8') ?>" class="grid gap-4 px-3 py-6 hover:bg-black/5 md:grid-cols-[16rem_1fr_auto] md:items-center">
                <div>
                    ...
                    <h2 class="mt-1 font-concert-one text-3xl text-dark-green dark:text-peach"><?= htmlspecialchars($project->listTitle, ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8') ?></h2>
                ...
                <span class="font-semibold text-dark-green dark:text-peach">Open guide</span>
            </a>
        <?php endforeach; ?>
    </div>
</section>
