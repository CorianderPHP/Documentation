        ...
        <div class="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
            ...
            <?php if ($canModerateTopic): ?>
                <form method="POST" action="/forum-demo/admin/topics" data-demo-form class="flex flex-wrap gap-2">
                    ...
                    <button name="action" value="<?= $topic['locked'] ? 'unlock' : 'lock' ?>" class="rounded-md border border-dark-green/25 px-3 py-2 text-sm font-semibold text-dark-green dark:border-peach/30 dark:text-peach"><?= $topic['locked'] ? 'Unlock topic' : 'Lock topic' ?></button>
                    <button name="action" value="hide" class="rounded-md bg-dark-green px-3 py-2 text-sm font-semibold text-true-white dark:bg-peach dark:text-black">Hide topic</button>
                </form>
            <?php endif; ?>
        </div>
    </div>
                        ...
                        <article class="grid gap-4 py-5 md:grid-cols-[11rem_1fr_auto]">
                            ...
                            <?php if ($canModerateReply): ?>
                                <form method="POST" action="/forum-demo/admin/replies" data-demo-form class="md:text-right">
                                    ...
                                    <button name="action" value="hide" class="rounded-md border border-dark-green/25 px-3 py-2 text-sm font-semibold text-dark-green dark:border-peach/30 dark:text-peach">Hide reply</button>
                                </form>
                            <?php endif; ?>
                        </article>
                    <?php endforeach; ?>
