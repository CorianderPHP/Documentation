...
<section class="forum-demo-theme relative px-4 py-8 font-poppins sm:px-6 lg:px-8">
    <div class="flex flex-col gap-4 border-b border-dark-green/15 pb-6 dark:border-mint/20 md:flex-row md:items-end md:justify-between">
        ...
        <a href="<?= htmlspecialchars($forumGuideReturn, ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8') ?>" class="inline-flex rounded-md border border-dark-green px-4 py-2 font-semibold text-dark-green dark:border-mint dark:text-mint">Back to guide step</a>
    </div>
