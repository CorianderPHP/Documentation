...
<section class="forum-demo-theme relative px-4 py-8 font-poppins sm:px-6 lg:px-8">
    <div class="border-b border-dark-green/15 pb-8 dark:border-peach/20">
        <div class="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div>
                <p class="text-sm font-semibold uppercase tracking-1 text-dark-green dark:text-peach">Demo environment</p>
                <h1 class="mt-3 font-concert-one text-4xl text-dark-green dark:text-peach md:text-6xl">Forum with permissions</h1>
            ...
            <div class="flex flex-wrap gap-3">
                ...
                <?php if ($currentUser): ?>
                    <form method="POST" action="/forum-demo/logout">
                        ...
                        <button class="rounded-md bg-dark-green px-4 py-2 font-semibold text-true-white dark:bg-peach dark:text-black">Log out</button>
                    </form>
                <?php else: ?>
                    <a href="/forum-demo/login" class="rounded-md bg-dark-green px-4 py-2 font-semibold text-true-white dark:bg-peach dark:text-black">Log in</a>
                <?php endif; ?>
            </div>
        </div>

        <div class="mt-6 grid gap-3 border-y border-dark-green/10 py-4 text-sm dark:border-peach/15 md:grid-cols-4">
            <div>
    ...
    <div class="mt-8">
        <section>
            <div class="flex items-center justify-between gap-4 border-b border-dark-green/10 pb-3 dark:border-peach/15">
                <h2 class="font-concert-one text-3xl text-dark-green dark:text-peach">Latest topics</h2>
                <a href="/forum-demo/topics" class="text-sm font-semibold text-dark-green dark:text-peach">View all</a>
            </div>
